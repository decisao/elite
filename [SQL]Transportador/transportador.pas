...
type
  TformTransportadores = class(TForm)
...
var
  formTransportadores: TformTransportadores;
...
procedure TformTransportadores.SetWhereDynamic(st, stmsg: string);
begin
  WhereArgDynamic := st;
  with lblWhere do
   begin
...
procedure TformTransportadores.btnAdicionarClick(Sender: TObject);
begin
...
procedure TformTransportadores.FormShow(Sender: TObject);
var
  i: byte;
begin
...
procedure TformTransportadores.FormCreate(Sender: TObject);
begin
...
procedure TformTransportadores.edtSelecionarKeyPress(Sender: TObject;
  var Key: Char);
var
  i, sel: byte;
  StrSQL: string;
...
procedure TformTransportadores.cmbOrdenarChange(Sender: TObject);
begin
     edtPesquisar.Clear;
     tmpSQLOrd := ' ORDER BY ' +
       ixTabelas[ixCampos[succ(cmbOrdenar.ItemIndex)].iTab] + '.' +
...
procedure TformTransportadores.cmbSelecionarChange(Sender: TObject);
begin
     edtSelecionar.Clear;
     edtSelecionar.SetFocus;
end;

procedure TformTransportadores.btnImprimirMouseEnter(Sender: TObject);
begin
//     if PrinterMenu.Items.Count = 0 then
//      btnImprimir.Enabled := False;
end;

procedure TformTransportadores.edtPesquisarChange(Sender: TObject);
begin
...
procedure TformTransportadores.GridMenuPopup(Sender: TObject);
begin
     AtivarZebra1.Checked := grdDados.Zebra;
end;

procedure TformTransportadores.Ativarzebra1Click(Sender: TObject);
begin
     grdDados.Zebra := not grdDados.Zebra;
end;

procedure TformTransportadores.Cordalinha1Click(Sender: TObject);
begin
     with ColorDialog do
      begin
...
procedure TformTransportadores.Cordotexto1Click(Sender: TObject);
begin
     with ColorDialog do
      begin
...
procedure TformTransportadores.qrySelecionarAfterOpen(DataSet: TDataSet);
var
  i: byte;
begin
     qrySelecionar.tag := 0;
...
procedure TformTransportadores.qryDetalhesAfterInsert(DataSet: TDataSet);
begin
...
procedure TformTransportadores.edtPesquisarKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TformTransportadores.btnExcluirClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     { salvo o registro }
...
procedure TformTransportadores.btnCancelarClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     with pgcDados do
      begin
...
procedure TformTransportadores.btnModificarClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     with pgcDados do
      begin
...
procedure TformTransportadores.qryDetalhesAfterOpen(DataSet: TDataSet);
begin
     { mascaras }
     with Dataset do
      begin
...
procedure TformTransportadores.dbrPessoaChange(Sender: TObject);
begin
...
procedure TformTransportadores.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
     CanClose := not qryDetalhes.Active;
end;

procedure TformTransportadores.fldESTADOmudar(Sender: TField);
begin
...
procedure TformTransportadores.fldCIDADEmudar(Sender: TField);
begin
  if Sender.AsString > '' then
...
procedure TformTransportadores.fldLOCALIDADEmudar(Sender: TField);
begin
  if Sender.AsString > '' then
...
procedure TformTransportadores.fldBAIRROmudar(Sender: TField);
begin
  if Sender.AsString > '' then
...
procedure TformTransportadores.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  atag: byte;
begin
...
procedure TformTransportadores.edtPesquisarEnter(Sender: TObject);
begin
...
procedure TformTransportadores.edtPesquisarExit(Sender: TObject);
begin
     if Sender is TEdit then
      begin
...
procedure TformTransportadores.btnSalvarClick(Sender: TObject);
const
     myEnter: Char = #13;
begin
     Screen.Cursor := crHourGlass;
...
procedure TformTransportadores.lblESTADOClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
...
procedure TformTransportadores.FormDestroy(Sender: TObject);
begin
...
procedure TformTransportadores.lblCIDADEClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
...
procedure TformTransportadores.lblLOCALIZACAOClick(Sender: TObject);
var
  nova: boolean;
begin
     Screen.Cursor := crHourGlass;
...
procedure TformTransportadores.CheckCPF1Error(Sender: TObject);
begin
     ShowMessage('O CPF digitado não é um CPF válido.');
end;

procedure TformTransportadores.CheckCGC1Error(Sender: TObject);
begin
     ShowMessage('O CNPJ digitado não é um CNPJ válido.');
end;

procedure TformTransportadores.DBEdit17Enter(Sender: TObject);
begin
     if Sender is TEdit then
      begin
       TEdit(Sender).Color := clInfoBK;
...
procedure TformTransportadores.grdDadosDblClick(Sender: TObject);
var
  scap: string;
begin
  scap := Caption;
...
procedure TformTransportadores.btnImprimirClick(Sender: TObject);
begin
