object formCartas_legendas: TformCartas_legendas
  Left = 272
  Top = 154
  Width = 477
  Height = 365
  ...
  object qryDetalhes: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM cartas_legenda'
      'WHERE ( CODCARTA = :CODCARTA AND CODLEGENDA = :CODLEGENDA )')
    UniDirectional = True
  ...
  object updDetalhes: TIBUpdateSQL
    ModifySQL.Strings = (
      'update cartas_legenda'
      'set'
      '  LEGENDA  = :LEGENDA'
      'where'
      '  CODCARTA = :OLD_CODCARTA AND'
      '  CODLEGENDA = :OLD_CODLEGENDA')
    InsertSQL.Strings = (
      'insert into cartas_legenda'
      '  (CODCARTA, CODLEGENDA, LEGENDA)'
      'values'
      '  (:CODCARTA, :CODLEGENDA, :LEGENDA)')
    DeleteSQL.Strings = (
      'delete from cartas_legenda'
      'where'
      '  CODCARTA = :OLD_CODCARTA AND'
      '  CODLEGENDA = :OLD_CODLEGENDA')
    Left = 324
