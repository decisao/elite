object formImpNotaCorpo: TformImpNotaCorpo
  Left = 224
  Top = 155
  Width = 477
  Height = 365
  ...
  object updDetalhes: TIBUpdateSQL
    ModifySQL.Strings = (
      ...
      '  COLUNA = :OLD_COLUNA')
    InsertSQL.Strings = (
      'insert into ITIMPNOTA'
      
        '  (NUMIMPNOTA, LINHA, COLUNA, CAMPO, TAMANHO, ALTURA, MASCARA, A' +
        'LINHAMENTO, '
      '   EFEITO)'
      'values'
      
        '  (:NUMIMPNOTA, :LINHA, :COLUNA, :CAMPO, :TAMANHO, :ALTURA, :MAS' +
        'CARA, :ALINHAMENTO, '
      '   :EFEITO)')
    DeleteSQL.Strings = (
      'delete from ITIMPNOTA'
      'where'
      '  NUMIMPNOTA = :OLD_NUMIMPNOTA and'
      '  LINHA = :OLD_LINHA and'
      '  COLUNA = :OLD_COLUNA')
