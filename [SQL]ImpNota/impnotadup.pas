...
var
  formImpNotaDup: TformImpNotaDup;
...
procedure TformImpNotaDup.SetWhereDynamic(st, stmsg: string);
begin
  WhereArgDynamic := st;
  with lblWhere do
   begin
...
procedure TformImpNotaDup.btnAdicionarClick(Sender: TObject);
begin
...
procedure TformImpNotaDup.FormShow(Sender: TObject);
var
  i: byte;
begin
...
procedure TformImpNotaDup.FormCreate(Sender: TObject);
begin
...
procedure TformImpNotaDup.edtSelecionarKeyPress(Sender: TObject);
var
  i, sel: byte;
  StrSQL: string;
begin
...
procedure TformImpNotaDup.cmbOrdenarChange(Sender: TObject);
begin
     edtPesquisar.Clear;
     tmpSQLOrd := ' ORDER BY ' +
       ixTabelas[ixCampos[succ(cmbOrdenar.ItemIndex)].iTab] + '.' +
...
procedure TformImpNotaDup.btnImprimirMouseEnter(Sender: TObject);
begin
//     if PrinterMenu.Items.Count = 0 then
//      btnImprimir.Enabled := False;
end;

procedure TformImpNotaDup.edtPesquisarChange(Sender: TObject);
begin
...
procedure TformImpNotaDup.GridMenuPopup(Sender: TObject);
begin
     AtivarZebra1.Checked := grdDados.Zebra;
end;

procedure TformImpNotaDup.Ativarzebra1Click(Sender: TObject);
begin
     grdDados.Zebra := not grdDados.Zebra;
end;

procedure TformImpNotaDup.Cordalinha1Click(Sender: TObject);
begin
     with ColorDialog do
      begin
...
procedure TformImpNotaDup.Cordotexto1Click(Sender: TObject);
begin
     with ColorDialog do
      begin
...
procedure TformImpNotaDup.qrySelecionarAfterOpen(DataSet: TDataSet);
var
  i: byte;
begin
     qrySelecionar.tag := 0;
...
procedure TformImpNotaDup.qryDetalhesAfterInsert(DataSet: TDataSet);
begin
    { número da nota pai }
    with Dataset do
     begin
...
procedure TformImpNotaDup.edtPesquisarKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TformImpNotaDup.btnExcluirClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     { salvo o registro }
...
procedure TformImpNotaDup.btnCancelarClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     with pgcDados do
      begin
...
procedure TformImpNotaDup.btnModificarClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     with pgcDados do
      begin
...
procedure TformImpNotaDup.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
     CanClose := not qryDetalhes.Active;
end;

procedure TformImpNotaDup.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  atag: byte;
begin
...
procedure TformImpNotaDup.edtPesquisarEnter(Sender: TObject);
begin
...
procedure TformImpNotaDup.edtPesquisarExit(Sender: TObject);
begin
     if Sender is TEdit then
      begin
...
procedure TformImpNotaDup.btnSalvarClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
     { salvo o registro }
...
procedure TformImpNotaDup.FormDestroy(Sender: TObject);
begin
...
procedure TformImpNotaDup.DBEdit2KeyPress(Sender: TObject; var Key: Char);
begin
        dmoPrincipal.PointToComma(Key);

end;

procedure TformImpNotaDup.DBEdit1KeyPress(Sender: TObject; var Key: Char);
begin
        dmoPrincipal.PointToComma(Key);

end;

procedure TformImpNotaDup.DBEdit3KeyPress(Sender: TObject; var Key: Char);
begin
        dmoPrincipal.PointToComma(Key);

end;

procedure TformImpNotaDup.DBEdit5KeyPress(Sender: TObject; var Key: Char);
begin
        dmoPrincipal.PointToComma(Key);

end;

procedure TformImpNotaDup.DBEdit6KeyPress(Sender: TObject; var Key: Char);
begin
        dmoPrincipal.PointToComma(Key);

end;

procedure TformImpNotaDup.lblREAJUSTEClick(Sender: TObject);
begin
     Screen.Cursor := crHourGlass;
...
procedure TformImpNotaDup.DBEdit3Enter(Sender: TObject);
begin
     if Sender is TEdit then
      begin
       TEdit(Sender).Color := clInfoBK;
...
procedure TformImpNotaDup.grdDadosDblClick(Sender: TObject);
var
  scap: string;
begin
  scap := Caption;
...
procedure TformImpNotaDup.btnImprimirClick(Sender: TObject);
begin
...
procedure TformImpNotaDup.btnAdicionarMouseEnter(Sender: TObject);
begin
   if Sender is TToolbarButton97 then
     (Sender as TToolbarButton97).Font.Style := [fsBold, fsUnderline];
end;

procedure TformImpNotaDup.btnAdicionarMouseExit(Sender: TObject);
begin
   if Sender is TToolbarButton97 then
