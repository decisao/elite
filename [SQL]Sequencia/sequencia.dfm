object formSequencia: TformSequencia
  Left = 235
  Top = 113
  Width = 477
  Height = 411
  ...
  object qryMaxSeq: TIBQuery
    Database = dmoPrincipal.Database
    Transaction = traMaxSeq
    BufferChunks = 100
    CachedUpdates = False
    SQL.Strings = (
      'SELECT'
      '  MAX( CODIGO ) + 1 AS CODIGO'
      'FROM'
      '  SEQUENCIA')
    UniDirectional = True
    Left = 45
  ...
  object traMaxSeq: TIBTransaction
    Active = False
    DefaultDatabase = dmoPrincipal.Database
    IdleTimer = 1024
    DefaultAction = TACommitRetaining
