object formImprimirOSaberta2: TformImprimirOSaberta2
  Left = 268
  Top = 220
  ...
  object qryCabNota: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  IM.ALTURA,'
      '  IM.EFEITOBASE,'
      '  CI.PRINT_OS_2A AS PRINT_NOTA,'
      '  CI.COPIAS_OS_2A AS COPIAS'
      'FROM'
      '  IMPNOTA IM, SISCONFIG CI'
      'WHERE'
      '  IM.NUMIMPNOTA = CI.OSABERTA_PADRAO_2A AND'
