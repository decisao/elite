object formImpBoletoCorpo: TformImpBoletoCorpo
  Left = 246
  Top = 157
  Width = 477
  Height = 365
  ...
  object qryDetalhes: TIBQuery
    ...
    CachedUpdates = True
    SQL.Strings = (
      'SELECT * FROM ITIMPBOLETO'
      'WHERE (NUMIMPBOLETO = :NUMIMPBOLETO) AND'
      '(LINHA = :LINHA) AND (COLUNA = :COLUNA)'
      ' ')
    UniDirectional = True
  ...
  object updDetalhes: TIBUpdateSQL
    ModifySQL.Strings = (
      ...
      '  EFEITO = :EFEITO'
      'where'
      '  NUMIMPBOLETO = :OLD_NUMIMPBOLETO and'
      '  LINHA = :OLD_LINHA and'
      '  COLUNA = :OLD_COLUNA')
    InsertSQL.Strings = (
      'insert into ITIMPBOLETO'
      
        '  (NUMIMPBOLETO, LINHA, COLUNA, CAMPO, TAMANHO, ALTURA, MASCARA,' +
        ' ALINHAMENTO, '
      '   EFEITO)'
      'values'
      
        '  (:NUMIMPBOLETO, :LINHA, :COLUNA, :CAMPO, :TAMANHO, :ALTURA, :M' +
        'ASCARA, '
      '   :ALINHAMENTO, :EFEITO)')
    DeleteSQL.Strings = (
      'delete from ITIMPBOLETO'
      'where'
      '  NUMIMPBOLETO = :OLD_NUMIMPBOLETO and'
      '  LINHA = :OLD_LINHA and'
      '  COLUNA = :OLD_COLUNA')
