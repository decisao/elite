object formHistoque: TformHistoque
  Left = 147
  Top = 93
  Width = 477
  Height = 365
  ...
  object updDetalhes: TIBUpdateSQL
    ModifySQL.Strings = (
      ...
      '  DATA = :OLD_DATA and'
      '  ESTOQUEATUAL = :OLD_ESTOQUEATUAL')
    InsertSQL.Strings = (
      'insert into MOVESTOQUE'
      '  (CODPRODUTO, DATA, ESTOQUEANTERIOR, ESTOQUEATUAL, MOVIMENTO)'
      'values'
      '  (:CODPRODUTO, :DATA, :ESTOQUEANTERIOR, :ESTOQUEATUAL, '
      ':MOVIMENTO)')
    DeleteSQL.Strings = (
