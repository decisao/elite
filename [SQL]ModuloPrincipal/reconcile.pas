...
const
  ActionStr: array[TReconcileAction] of string = ('Voltar e editar', 'Abortar', 'Unir',
    'Editar aqui', 'Desistir', 'Original');
  UpdateKindStr: array[TUpdateKind] of string = ('Modificar', 'Inserir',
    'Excluir');
  SCaption = 'Erro de gravação: %s';
  SUnchanged = '<original>';
  SBinary = '(Binario)';
